...
import imageVI from "../../../../../../Images/surgeryBlue.png";
...
function SurgeryStart(props) {
    ...
    useEffect(async () => {
        ...
        setuser(userData);
        Axios.get(`${hostUrl}/surgery/${userData.vetid}`).then((response) => {
    ...
    function reloadsurgery() {
        Axios.get(`${hostUrl}/surgery/${users[0].vetid}`).then((response) => {
            setsurgery(response.data);
            // console.log(response.data)
            setValidated(false);
        });
    ...
    return (
        ...
        >
            ...
            <Modal show={showDelete} onHide={handleCloseDelete}>
                ...
                <Modal.Body>Are you sure do you want to delete this service?</Modal.Body>
                <Modal.Footer>
            ...
            >
                <Popover id="popover-contained">
                    ...
                    <Popover.Body>
                        <p>This table shows the vaccination services. </p>
                    </Popover.Body>
                </Popover>
            </Overlay>
            <MaterialTable
