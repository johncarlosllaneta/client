...
import { ToastSurgery } from "../../../../../../Components/Toast";
...
function Surgery(props) {
  ...
  function insertMedicines(consultId) {
    Axios.put(`${hostUrl}/doc/surgery/${surgeryId}`, {
      ...
      render: (row) => (
        <div>
          <OverlayTrigger
            placement="top-start"
            delay={{ show: 250 }}
            overlay={renderTooltip({ msg: "Add prescription and findings" })}
          >
            <Button
              variant="info"
              style={{
            ...
            >
              <AiOutlineFileDone style={{ fontSize: 25 }} /> Findings
            </Button>
          </OverlayTrigger>
        </div>
      ),
  ...
  return (
    <div>
      ...
      >
        ...
        <Modal.Body>
          Are you sure you want you are done to this surgery?{" "}
        </Modal.Body>
        <Modal.Footer>
